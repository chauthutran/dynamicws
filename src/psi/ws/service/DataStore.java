...
//        public int requestTimeout = Util.REQUEST_TIMEOUT; 
    ...
    @Override
        public String toString() {
                return "DataStore: responseCode=" + responseCode + ", output="
                                + output + ", data=" + data + ", referenceId=" + referenceId
                                + ", sendStr=" + sendStr + ", voucherCode=" + voucherCode
                                + ", CUIC=" + CUIC + ", outMessage=" + outMessage 
                                + ", detailActionMsg=" + detailActionMsg
    ...
    public void clearContent()
    {
        ...
        public void setResponseOutputWithExThrow( int responseCodeInput, String outMessageInput ) throws Exception
        {

                if ( responseCodeInput > responseCode ) responseCode = responseCodeInput;
