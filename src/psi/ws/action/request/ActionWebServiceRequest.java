...
public class ActionWebServiceRequest extends ActionRequest
{
    ...
    public ActionWebServiceRequest( Configuration configuration, JSONObject httpRequestData, String link, String requestType, ActionJSEngine actionJSEngine, JSONObject actionListByName ) throws ActionException
    {
        super();
        
        if( configuration.getServer() == null || configuration.getUsername() == null || configuration.getPassword() == null )
        {
    ...
    private String generateRequestURL( JSONObject httpRequestData, String link, JSONObject actionList ) throws ActionException
    {            
        String url = this.configuration.getServer() + link;
